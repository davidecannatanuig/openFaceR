...
#' test datasets
#'
#' Openfacer provides 4 test OpenFace datasets: John, Teddy, Lara and Paula.
...
#'   \item{gaze_0_x to gaze_0_z}{The coordinates of the gaze of the left eye}
#'   \item{gaze_1_x to gaze_1_z}{The coordinates of the gaze of the right eye}
#'   \item{gaze_angle_x to gaze_angle_y}{eye gaze direction in radians}
#'   \item{eye_lmk_x_0 to eye_lmk_y_55}{two dimensional coordinates of the eyes in pixels}
#'   \item{eye_lmk_X_0 to eye_lmk_Z_55}{three dimensional coordinates of the eyes in millimeters}
#'   \item{pose_Tx to pose_Tz}{The location of the head in respect of the camera in millimeters}
#'   \item{pose_Rx, pose_Ry, pose_Rz}{pitch, yaw and roll of the head in radiants}
#'   \item{X_0Z_67}{coordinates of the 67 3D face landmarks in millimeters}
#'   \item{AU01_r to AU45_r}{action units intensity, as a number from 0 - inactive - to 1 - completely active -}
#'   \item{AU01_r to AU45_r}{action units presence. 1 is present, 0 is not present}
#'}
#'
...
#' @details to know more chec the URL:  \url{https://github.com/TadasBaltrusaitis/OpenFace/wiki/Output-Format}
#' @name test_face
#' @keywords test_face
